                ...
                <div class="col-lg-9">
                    <div class="urgent-call">
                        ...
                        <div class="text">
                            ...
                            <p>Need assistance or have a query? Reach out to us! We&#039;re committed to providing you with timely and helpful responses. For immediate assistance, our customer service team is readily available via phone or email. We value your time and strive to address your needs swiftly and efficiently.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="address-wrapper" style={{background:" linear-gradient(90deg,rgba(0,0,0,.9),rgba(0,0,0,0.8))" }}>
                        <div class="address-item">
                            ...
                            <div class="content">
                                <h5>Email</h5>
                                <a href="mailto:+9943453453">info@example.com</a>
                            </div>
                        </div>
                        <div class="address-item">
                            <div class="icon">
